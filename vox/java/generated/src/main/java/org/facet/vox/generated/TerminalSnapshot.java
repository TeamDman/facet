...
public final class TerminalSnapshot {
  ...
  public TerminalSnapshot(String sessionId, long sequence, int width, int height, TerminalFrameEncoding encoding, TerminalFrameKind kind, long stride, int tileX, int tileY, int tileWidth, int tileHeight, byte[] payload, boolean complete, TerminalCursor cursor, boolean selectionPresent, TerminalSelection selection) {
  ...
  public static final PhonAdapter<TerminalSnapshot> ADAPTER = new PhonAdapter<>() {
    ...
    @Override public TerminalSnapshot decode(PhonDecoder decoder) throws PhonException { return new TerminalSnapshot(decoder.readString(), decoder.readI64(), decoder.readU16(), decoder.readU16(), decoder.readAdapted(TerminalFrameEncoding.ADAPTER), decoder.readAdapted(TerminalFrameKind.ADAPTER), decoder.readU32(), decoder.readU16(), decoder.readU16(), decoder.readU16(), decoder.readU16(), decoder.readBytes(), decoder.readBool(), decoder.readAdapted(TerminalCursor.ADAPTER), decoder.readBool(), decoder.readAdapted(TerminalSelection.ADAPTER)); }
  };
  ...
  @Override public int hashCode() { return Objects.hash(sessionId, sequence, width, height, encoding, kind, stride, tileX, tileY, tileWidth, tileHeight, payload, complete, cursor, selectionPresent, selection); }
  @Override public String toString() { return "TerminalSnapshot" + java.util.List.of(sessionId, sequence, width, height, encoding, kind, stride, tileX, tileY, tileWidth, tileHeight, payload, complete, cursor, selectionPresent, selection); }
}
