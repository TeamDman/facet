...
public final class TerminalServiceDescriptor {
  ...
  public static final ServiceDescriptor INSTANCE = new ServiceDescriptor("Terminal", List.of(CONNECT, CAPABILITIES, PRESENTATION_CAPABILITIES, RESIZE, SEND_TEXT, SEND_KEY, SEND_MOUSE, SNAPSHOT, SUBSCRIBE_FRAMES, SUBSCRIBE_RASTER_FRAMES, GET_CONTENT, CANCEL, DISCONNECT));
